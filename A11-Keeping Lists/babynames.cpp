...
#include <string>
using namespace std;
/**     Reads name information, prints the name if total >= 0, and adjusts the total. 9
@param in_file the input stream 10
@param total the total percentage that should still be processed 11 */
